...
public class Gun : MonoBehaviour
{
    ...
    private void Shot(Vector3 startPoint, Vector3 direction)
    {
        ...
        if (target!=null){
            DamageMessage damageMesseage;
            damageMesseage.damager = gunHolder.gameObject;
            damageMesseage.amount=damage;
            damageMesseage.hitPoint=hit.point;
            damageMesseage.hitNormal = hit.normal;
            target.ApplyDamage(damageMesseage);
